...
Welcome to Web Development! It is a fun skill to develop and very manageable to do as a side hobby in your free time. I originally wrote this article to introduce web development to my colleagues in the medical field. This article serves as an orientation into the field, and the real learning is found in the linked tutorials. 
